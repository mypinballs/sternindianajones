...
class rPi_Desktop():
    ...
    def __init__(self):
        self.log = logging.getLogger('ij.rpi_desktop')
        self.log.info( "Init Colour rPi Desktop")
        self.ctrl = 0
        self.i = 0
        self.HD = False
    ...
    def draw_window(self,pixel,xoffset=0,yoffset=0):
        ...
        if 'pygame' in globals():
            ...
            self.log.error('Desktop init skipping setup_window(); pygame does not appear to be loaded.')
